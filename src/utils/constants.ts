...
export const QUIET_NODE_GITHUB_LINK = 'https://github.com/gauriaggarwal';
...
export const QUIET_NODE_LINKEDIN_LINK = 'https://www.linkedin.com/in/gauri-aggarwal-235996202/';
export const QUIET_NODE_TWITTER_LINK = '';
export const QUIET_NODE_DISCORD_LINK =
  'https://discordapp.com/users/781172165311070229';
